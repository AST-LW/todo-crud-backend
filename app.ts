...
import { jwtDecoderMiddleware } from "./middlewares/jwt.decoder.middleware";
...
app.use(
    "/todo-crud-backend/:version", // Specify a version parameter in the route
    jwtDecoderMiddleware, // JWT decoding for authorization
